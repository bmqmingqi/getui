 ...
 * VERSION 3.3.2.1
 */
namespace BmqMingQi\GeTui;
$basepath=dirname(__FILE__);
require_once($basepath . '/' . 'protobuf/pb_message.php');
require_once($basepath . '/' . 'igetui/IGt.Req.php');
require_once($basepath . '/' . 'igetui/IGt.Message.php');
require_once($basepath . '/' . 'igetui/IGt.AppMessage.php');
require_once($basepath . '/' . 'igetui/IGt.ListMessage.php');
require_once($basepath . '/' . 'igetui/IGt.SingleMessage.php');
require_once($basepath . '/' . 'igetui/IGt.Target.php');
require_once($basepath . '/' . 'igetui/template/IGt.BaseTemplate.php');
require_once($basepath . '/' . 'igetui/template/IGt.LinkTemplate.php');
require_once($basepath . '/' . 'igetui/template/IGt.NotificationTemplate.php');
require_once($basepath . '/' . 'igetui/template/IGt.TransmissionTemplate.php');
require_once($basepath . '/' . 'igetui/template/IGt.NotyPopLoadTemplate.php');
require_once($basepath . '/' . 'igetui/template/IGt.APNTemplate.php');
require_once($basepath . '/' . 'igetui/utils/GTConfig.php');
require_once($basepath . '/' . 'igetui/utils/HttpManager.php');
require_once($basepath . '/' . 'igetui/utils/ApiUrlRespectUtils.php');
require_once($basepath . '/' . 'igetui/utils/LangUtils.php');
